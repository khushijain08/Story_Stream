...
public class PostController {
    ...
    public ResponseEntity<PostDto> creaePost(@RequestBody PostDto postDto,@PathVariable Integer userId,@PathVariable Integer categoryId)
    {
    ...
    )throws IOException
    {
        ...
        response.setContentType("MediaType.IIMAGE_JPEG_VALUE");
